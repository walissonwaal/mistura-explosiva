  ...
  return (
    <div className="regras md:px-20 relative">
      ...
      <div className="py-6 px-6 md:py-20 md:px-20">
        ...
        <div className="flex">
          <div className="w-1/2">
            <ScrollReveal className="text-white text-lg font-medium">
          ...
          <ScrollReveal className="bg-mYellow rounded-3xl px-8 py-8 z-20 w-4/5">
            <ScrollReveal className="text-mPurple text-lg font-bold mb-5">
