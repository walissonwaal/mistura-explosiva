    ...
    <div className="regras md:px-20">
      <div className="py-6 px-6 md:py-20 md:px-20">
        ...
        <div className="text-justify md:text-start md:grid md:grid-cols-2 gap-20">
          <div>
            <ScrollReveal className="text-white text-xl md:text-2xl font-medium">
          ...
          <ScrollReveal className="bg-mYellow rounded-3xl px-8 py-8">
            <ScrollReveal className="text-mPurple text-xl md:text-2xl font-bold mb-5">
